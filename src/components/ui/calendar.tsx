  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-600 text-white hover:bg-blue-600 hover:text-white focus:bg-blue-600 focus:text-zinc-50 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 dark:focus:bg-zinc-50 dark:focus:text-zinc-900",
        day_today: "bg-blue-100 text-white dark:bg-zinc-800 dark:text-zinc-50",
        day_outside:
